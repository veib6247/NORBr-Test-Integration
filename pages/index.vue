<template>
  <div class="responsive-height flex w-full flex-col gap-4 overflow-auto py-5">
    <!-- TITLE -->
      ...
      >
        <AppNotification>
          <p>
            ...
            (mostly) unstyled to show the default look it comes with, but it is
            recommended for the merchant to style the forms to match their
